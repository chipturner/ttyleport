...
Similar to Eternal Terminal but socket-based. Currently single-client only (but persistent — shell survives client disconnect).
...
MVP complete with persistent sessions. All modules implemented and tested (14 tests: 9 protocol codec + 5 e2e integration including reconnect).
